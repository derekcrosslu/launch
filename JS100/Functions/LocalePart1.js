...
// Examples:
console.log("extractLanguage('en_US.UTF-8'): ", extractLanguage('en_US.UTF-8'));
console.log("extractLanguage('en_GB.UTF-8'): ", extractLanguage('en_GB.UTF-8'));
console.log("extractLanguage('ko_KR.UTF-16'): ", extractLanguage('ko_KR.UTF-16'));
