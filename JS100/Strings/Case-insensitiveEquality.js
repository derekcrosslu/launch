...
string1.toLowerCase() === string3.toLowerCase(); // true
console.log("string1.toLowerCase() === string2.toLowerCase(): ", string1.toLowerCase() === string2.toLowerCase());
console.log("string1.toLowerCase() === string3.toLowerCase(): ", string1.toLowerCase() === string3.toLowerCase());
// string1.toLowerCase() === string2.toLowerCase():  true
